    ...
    while True:
        ...
        try:
            if cmd[0] == '-car':
                ...
                if cmd[1] == '-u':
                    config.update({'ktime': {'u': float(cmd[2])}})
                    
                elif cmd[1] == '-s':
                    config.update({'ktime': {'s': float(cmd[2])}})
                ...
                if cmd[1] == '-u':                    
                    if cmd[2] == 'true':
                        config.update({'denter': {'u': True}})
                    
                    elif cmd[2] == 'false':
                        config.update({'denter': {'u': False}})
                    ...
                    if cmd[2] == 'true':
                        config.update({'denter': {'s': True}})
                    
                    elif cmd[2] == 'false':
                        config.update({'denter': {'s': False}})
